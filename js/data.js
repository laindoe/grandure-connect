const BRANDS = [
  {
    ...
    brandUniverse: {
      world: { name: '', description: '', tension: '', setting: '' },
      belief: { statement: '', differentiator: '', oldParadigm: '' },
      citizens: { name: '', who: '', unites: '', transformation: '' },
      symbols: [],
      aesthetic: { palette: [], typography: '', moodWords: [], moodboard: [] },
      invitations: { onRamp: '', cta: '', reward: '' },
    },
    characters: [],
    brandAssets: { logos: [], colors: [], typography: [], moodboards: [], visualRefs: [], imagery: [], icons: [] },
  },
  {
    id: '2',
